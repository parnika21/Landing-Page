...
function Search() {
  ...
  return (
    <div className="search relative h-[65rem] px-[5rem] bg-[##DFF6FF] pt-[18rem] pb-[10rem] mt-[-15rem] z-[1] flex items-center justify-between rounded-b-[5rem] text-[#06283D]">
      {/* left side */}
      <div className="left flex-1">
       ...
       <motion.img
          ...
          src={require("../img/new1.png")}
          alt=""
          className="w-[7rem] top-[33rem] left-[17rem] absolute"
        />
      ...
      {/* right side */}
        ...
        <div className="searchbar flex justify-start w-[100%]">
          <input
            type="text"
            placeholder="Search Your Medical Record"
            className="flex-[19] outline-none bg-[#020917] rounded-xl p-3 h-[3rem]"
          />
          {/* SearchIcon */}
          <div className="searchIcon flex flex-1 items-center rounded-xl ml-4 bg-gradient-to-bl from-[#1363DF] to-[#1363DF] p-4 h-[3rem]">
            <img
        ...
        <div className="detail flex flex-col mt-5 text-4xl">
          <span>Get an easy access to your saved records</span>
          <span>
            <b>Through Name or Direct URL</b>
          </span>
        ...
        <div>
          <span className= "detail flex flex-col mt-5 text-4xl text-[#1363DF]"><b>Just a click away!</b></span>
        </div>
